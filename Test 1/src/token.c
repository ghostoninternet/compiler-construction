...
struct {
  ...
  {"TO", KW_TO},
  {"BYTE", KW_BYTE},
  {"REPEAT", KW_REPEAT}, // Add this line
  {"UNTIL", KW_UNTIL} // Add this line
};
...
char *tokenToString(TokenType tokenType) {
  ...
  case KW_BYTE: return "keyword BYTE"; // Add this line
  case KW_REPEAT: return "keyword REPEAT"; // Add this line
  case KW_UNTIL: return "keyword UNTIL"; // Add this line
  ...
  case SB_LSEL: return "\'(.\'";
  case SB_RSEL: return "\'.)\'";
  case SB_POWER: return "\'**\'"; // Add this line
